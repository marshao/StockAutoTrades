...
def main():
    ...
    # MACDPattern._get_best_pattern('sh603658')
    ...
    for each_quo in quo:
        for each_ga in gama:
            for each_beta in beta:
                MACD_Trading_Signal_Cal._MACD_trading_signals(period="m30", stock_code="sh603658", quo=each_quo,
                                                              ga=each_ga, beta=each_beta)
                MACD_Ending_Profit_Cal._MACD_ending_profits(period='m30', stock_code='sh603658')
        ...
        for each_ga in gama:
            for each_beta in beta:
                MACD_Trading_Signal_Cal._single_pattern_signal_cal(MACD_pattern=pattern_signal, period="m30",
                                                                   stock_code="sh603658", quo=each_quo, ga=each_ga,
